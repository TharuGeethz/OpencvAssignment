...
int main(int argc, char *argv[])
{
    ...
    img_1 = cv::imread("../data-dir/Fish/img/0001.jpg" , IMREAD_GRAYSCALE);
    img_2 = cv::imread("../data-dir/Fish/img/0199.jpg" , IMREAD_GRAYSCALE);
    ...
    features0001Write.open( "../FlannBased/features0001.csv", std::ios::out);
    features0002Write.open( "../FlannBased/features0199.csv", std::ios::out);
    ...
    drawMatches( image1_crop, keypoints_1_crop, img_1, keypoints_1,good_matches, img_matches, Scalar::all(-1), Scalar::all(-1), vector<char>(), DrawMatchesFlags::NOT_DRAW_SINGLE_POINTS );
    string fileOutputPath = "../FlannBased/output/output_matching.jpg";
